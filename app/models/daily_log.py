...
class DailyLog(Base):
    ...
    incomes = relationship("Income", back_populates="daily_log", cascade="all, delete-orphan")
...
class Income(Base):
    """Individual income line item attached to a daily log (e.g. harvest sales)."""
    ...
    # Relationships
    daily_log = relationship("DailyLog", back_populates="incomes")
